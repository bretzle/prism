...
pub fn Vec2(comptime Scalar: type) type {
    return extern struct {
        ...
        pub inline fn create(xs: Scalar, ys: Scalar) VecN {
            return .{ .v = .{ xs, ys } };
        }
...
pub fn Vec3(comptime Scalar: type) type {
    return extern struct {
        ...
        pub inline fn create(xs: Scalar, ys: Scalar, zs: Scalar) VecN {
            return .{ .v = .{ xs, ys, zs } };
        }
        ...
        pub inline fn swizzle(v: *const VecN, xc: VecComponent, yc: VecComponent, zc: VecComponent) VecN {
...
pub fn Vec4(comptime Scalar: type) type {
    return extern struct {
        ...
        pub inline fn create(xs: Scalar, ys: Scalar, zs: Scalar, ws: Scalar) VecN {
...
pub fn VecShared(comptime Scalar: type, comptime VecN: type) type {
    return struct {
        ...
        pub inline fn max(a: *const VecN, b: *const VecN) VecN {
            return switch (VecN.n) {
                inline 2 => VecN.create(
                    @max(a.x(), b.x()),
                    @max(a.y(), b.y()),
                ),
                inline 3 => VecN.create(
                    @max(a.x(), b.x()),
                    @max(a.y(), b.y()),
                    @max(a.z(), b.z()),
                ),
                inline 4 => VecN.create(
                    @max(a.x(), b.x()),
                    @max(a.y(), b.y()),
                    @max(a.z(), b.z()),
                    @max(a.w(), b.w()),
        ...
        pub inline fn format(self: VecN, comptime fmt: []const u8, options: std.fmt.FormatOptions, writer: anytype) @TypeOf(writer).Error!void {
