...
pub const vec2 = Vec2.create;
pub const vec3 = Vec3.create;
...
pub const quat = Quat.create;
pub const mat2x2 = Mat2x2.create;
pub const mat3x3 = Mat3x3.create;
pub const mat4x4 = Mat4x4.create;

/// Half-precision f16 initializers
pub const vec2h = Vec2h.create;
pub const vec3h = Vec3h.create;
pub const vec4h = Vec4h.create;
pub const vec2hFromInt = Vec2h.fromInt;
pub const vec3hFromInt = Vec3h.fromInt;
pub const vec4hFromInt = Vec4h.fromInt;
pub const quath = Quath.create;
pub const mat2x2h = Mat2x2h.create;
pub const mat3x3h = Mat3x3h.create;
pub const mat4x4h = Mat4x4h.create;

/// Double-precision f64 initializers
pub const vec2d = Vec2d.create;
pub const vec3d = Vec3d.create;
pub const vec4d = Vec4d.create;
pub const vec2dFromInt = Vec2d.fromInt;
pub const vec3dFromInt = Vec3d.fromInt;
pub const vec4dFromInt = Vec4d.fromInt;
pub const quatd = Quatd.create;
pub const mat2x2d = Mat2x2d.create;
pub const mat3x3d = Mat3x3d.create;
pub const mat4x4d = Mat4x4d.create;
