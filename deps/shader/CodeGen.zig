...
pub fn generate(allocator: std.mem.Allocator, air: *const Air, out_lang: Language, use_spirv_cross: bool, debug_info: DebugInfo, entrypoint: ?Entrypoint, bindings: ?*const BindingTable, label: ?[:0]const u8) ![]const u8 {
