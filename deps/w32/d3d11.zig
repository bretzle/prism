...
pub const CLEAR_FLAGS = packed struct(u32) {
    DEPTH: bool = false,
    STENCIL: bool = false,
    __unused: u30 = 0,
};
...
pub const IDeviceContext = extern struct {
    ...
    const VTable = extern struct {
        ...
        clear_depth_stencil_view: *const fn (*IDeviceContext, view: *IDepthStencilView, flags: CLEAR_FLAGS, depth: f32, stencil: u8) callconv(.winapi) void,
    ...
    pub fn clearDepthStencilView(self: *IDeviceContext, view: *IDepthStencilView, flags: CLEAR_FLAGS, depth: f32, stencil: u8) void {
        return (self.vtable.clear_depth_stencil_view)(self, view, flags, depth, stencil);
    }
