...
pub const REGISTER_COMPONENT_TYPE = enum(u32) {
    UNKNOWN = 0,
    UINT32 = 1,
    SINT32 = 2,
    FLOAT32 = 3,
...
pub const MIN_PRECISION = enum(u32) {
    DEFAULT = 0,
    FLOAT_16 = 1,
    FLOAT_2_8 = 2,
    RESERVED = 3,
...
pub const SIGNATURE_PARAMETER_DESC = extern struct {
    SemanticName: LPCSTR,
    SemanticIndex: u32,
    Register: u32,
...
pub const IShaderReflection = extern struct {
    ...
    const VTable = extern struct {
        ...
        get_input_parameter_desc: *const fn (*IShaderReflection, index: u32, desc: *SIGNATURE_PARAMETER_DESC) callconv(.winapi) HRESULT,
    ...
    pub fn getInputParameterDesc(self: *IShaderReflection, index: u32, desc: *SIGNATURE_PARAMETER_DESC) HRESULT {
        return (self.vtable.get_input_parameter_desc)(self, index, desc);
    }
